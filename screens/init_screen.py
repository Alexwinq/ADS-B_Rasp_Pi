...
class InitScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Root layout: FloatLayout lets us position widgets anywhere using pos_hint
        root_layout = FloatLayout()

        # Main loading label centered (inside a BoxLayout for padding & vertical alignment)
        box_layout = BoxLayout(orientation='vertical', padding=50, size_hint=(1, 1))
        self.label = Label(
            text="Scanning for Aircraft.",
            font_size=48,
            color=[210 / 255, 180 / 255, 140 / 255, 1],  # D2B48C tan color
            font_name=font_path,
            halign="center",
            valign="middle"
        )
        ...
        # Remove manual positioning function and bindings; pos_hint handles this now
        # Update GPS text every second
